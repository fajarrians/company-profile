                ...
                <div class="p-5">
                    <table class="table-auto w-full mt-5">
                        <tr>
                            ...
                            <th class="border px-4 py-2" width="20%">Visi</th>
                            <th class="border px-4 py-2" width="20%">Misi</th>
                            <th class="border px-4 py-2" width="25%">Profil</th>
                            <th class="border px-4 py-2" width="5%">Aksi</th>
                          </tr>
                          @forelse ($profil as $item)
                            <tr>
                                <td class="border px-4 py-2">{{ $item->sejarah }}</td>
                                <td class="border px-4 py-2">{{ $item->visi }}</td>
                                <td class="border px-4 py-2">{{ $item->misi }}</td>
